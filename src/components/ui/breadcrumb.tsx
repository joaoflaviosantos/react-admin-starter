...
>(({ asChild, className, children, ...props }, ref) => {
  ...
  if (asChild && React.isValidElement(children)) {
    ...
    const childRef = (children as React.ReactElement & { ref?: React.Ref<HTMLAnchorElement> }).ref;
    ...
    return React.cloneElement(children, {
      ...
      onClick: mergeHandlers(
        childProps.onClick as React.MouseEventHandler<HTMLAnchorElement> | undefined,
        props.onClick,
      ),
    });
  }
